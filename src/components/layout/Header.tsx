      ...
      <div className="bg-gray-950 text-gray-300 text-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-9">
          <div className="hidden sm:flex items-center gap-4">
            ...
            <Link href="/impressum" className="hover:text-white transition-colors">{"Über uns"}</Link>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white border-b border-gray-200">
          <div className="px-4 py-4 space-y-1">
            ...
            <Link href="/kategorie/fuss-und-kofferraummatten-set" className="block px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>{"Fuss- und Kofferraummatten Set"}</Link>
            ...
            <Link href="/produkte" className="block px-3 py-2.5 text-sm font-semibold text-amber-600 hover:bg-amber-50 rounded-lg" onClick={() => setMobileMenuOpen(false)}>{"Alle Produkte anzeigen"} &rarr;</Link>
          </div>
        </div>
      )}
    </header>
